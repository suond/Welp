...
dummyAvatar = open('https://s3-us-west-1.amazonaws.com/aa-welp-dev/mJvRKSNXRWpTFJJhTFvy2qpN')
...
burgerPhoto = open('https://s3-us-west-1.amazonaws.com/aa-welp-dev/burger.jpg')
restBurger.photos.attach(io: burgerPhoto, filename: 'burger.jpg')
